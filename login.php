...
<head>
    ...
    <title>SARANA PRASARANA SMK MANBAUL 'ULUM</title>
...
<div align="center">
            ...
            <div align="center" style="width:320px;margin-top:5%;">
                <form method="post" class="well well-lg p-5" action="" style="-webkit-box-shadow: 0px 0px 20px #888888;">
                    ...
                    <h4>Selamat Datang di Sistem SARANA PRASARANA SMK MANBAUL 'ULUM</h4>
                    <br>
        ...
        <footer align="center">
            Created By <a href="#" title="T.P"><i class="fa fa-copyright" aria-hidden="true">KELOMPOK 1</i></a>
        </footer>
